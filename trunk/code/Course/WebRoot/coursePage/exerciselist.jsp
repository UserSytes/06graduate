												...
												<tr>
													<td height="100%" align="center" valign="top">
														...
														<table class=editTable cellSpacing=1 cellPadding=0
															...
															<s:iterator value="chapterList" status="chapter" id="chap">
																<tr  bgcolor="#FFFDF0" height="30" align="center" valign="middle">
																	<td width="30%">
																		<s:property value="name" />
																	</td>
																	<td width="70%" align="center" valign="top">
																		<s:iterator value="#chap.exercises" status="exercise">
																				<br>
																						<a
                     															...
                     															<s:param name="fileName"> 
                																		...
                																		</s:url>"onclick="JAVAscript:if(!confirm('确认下载附件？')) return false;return true;">
																							<font color="blue"><s:property
																									value="filename" /> </font> </a>
																		</s:iterator>
																	</td>
																</tr>
															</s:iterator>
