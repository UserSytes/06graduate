											...
											<div style="padding: 15px 30px;">
												<div class="alert_info"
													style="background-image: url(${ctx}/coursepage/style/common/error_big.gif)">
														...
														<font style="font-size: 14px;"><ul><li>您还未登录或者长时间未进行任何操作！</li></ul> </font>
														<ul class="alertmsg"
														style="margin-top: 8px; text-decoration: underline"><li><a href="<s:url action="homepageNewsAction"/>">[请点击这里回到平台首页]</a></li></ul>
