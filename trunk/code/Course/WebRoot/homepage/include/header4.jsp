...
<TD ROWSPAN=3><IMG SRC="${ctx}/homepage/images/back-1.jpg" WIDTH=209 HEIGHT=102 ALT=""></TD>
					<TD ROWSPAN=2><a href="${ctx}/homepage/index.jsp"><IMG SRC="${ctx}/homepage/images/1-case-1.jpg" WIDTH=85 HEIGHT=70 ALT="" border="0"></a></TD>
					...
					<TD ROWSPAN=2><a href="${ctx}/homepage/searchbyschool.jsp"><IMG SRC="${ctx}/homepage/images/3-case-4.jpg" WIDTH=86 HEIGHT=70 ALT="" border="0"></a></TD>
