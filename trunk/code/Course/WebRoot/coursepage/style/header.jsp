...
<html>	
  <head>  
	<script src="${ctx}/js/jquery-1.4.1-and-plugins.min.js" type="text/javascript"></script>
...
$(function(){
  ...
  <body>
    <div class="content border_bottom">
	 <ul id="sub_nav">
		 <li><a href="${ctx}/homepage/index.jsp">首页</a></li>

		 <li><a href="javascript:window.external.addFavorite('http://www.yoursite.com','<s:property value="course.name" />-厦门大学课程网络平台')">加入收藏</a></li>
...
<div class="content dgreen-bg">
     <div class="content">
	 <ul id="main_nav">
		 <li class="nobg"><a href="goIndexQueryAction.action">课程首页</a></li>
...
<li><a href="#">通知公告</a>
		<ul>
					 <li><a href="<s:url action="getNoticeBySortAction"> 
                     			<s:param name="sort"> 
                       			 	0 
                    			</s:param>
                					</s:url>">课程通知</a></li>
		 ...
		 <li><a href="#">课程教案</a>
		 <ul>
					 <li><a href="<s:url action="getAllCoursewareAction"> 
                					</s:url>">课件教案</a></li>
					 <li><a href="<s:url action="getAllExerciseAction"> 
                					</s:url>">作业习题</a></li>
					 <li><a href="<s:url action="getAllExperimentAction"> 
                					</s:url>">实验指导</a></li>
		 </ul></li>
		 <li><a href="#">课程相关</a>
		 <ul>
					 ...
					 <li><a href="<s:url action="getAllExaminationAction"> 
                					</s:url>">课程试卷</a></li>
					 <li><a href="<s:url action="getAllBookAction"> 
                					</s:url>">参考书籍</a></li>
		 </ul></li>
