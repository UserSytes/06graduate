			...
			<div id="right-cnt">
				...
				<div class="pages">
					<h2>
						...
						<a href="<s:url action="getAllExerciseAction"> 
                					</s:url>">作业习题</a>&gt;详细浏览
					</h2>
					<br class="clear" />
				</div>
				...
				<div>
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr height="69">
							<td valign="bottom" align="left">
								<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td><font color="#966f48"style="font-size:16px; font-weight:bold">作业习题</font></td>
								</tr>
								<tr>
					...
					<td width="724" align="center">
						...
						<tr bgcolor="#f1e1be">
							...
							<td>&nbsp;</td>
							<td width="150" height="40" align="center"><font style="font-size:14px;font-weight:bold;">习题名称</font></td>
							<td>&nbsp;</td>
...
<s:iterator value="exerciseList" status="exercise">
						<tr height="33" bgcolor="#fdfbf3"  <s:if test="#courseware.even">style="background-color:#faefda"</s:if>>
							<td align="center"><font color="#74582f"><s:property value="#exercise.count" /></font></td>
							<td></td>
