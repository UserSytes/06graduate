...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>管理系统</title>
		<link href="img/left_css.css" rel="stylesheet" type="text/css">
	</head>
									...
									<TABLE id=submenu1 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="getTeacherInfoAction.action" target=main>个人信息</A>
												</TD>
											</TR>
											<TR>
												<TD>
												...
												<TD height=23>
													<A href="changepassword.jsp" target=main>修改密码</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<table id="submenu2" cellspacing="0" cellpadding="0"
										...
										<tbody>
											<tr>
												...
												<td height="23">
													<a href="getMyCourseAction.action" target="main">我的课程</a>┆
													<a href="addnewcourse.jsp" target="main">课程申请</a>
												</td>
											</tr>
											<tr>
												<td>
												...
												<td height="23">
													<a href="Article/Article_Manage.asp?action=ListisAccept"
														target="main">添加学生</a>┆
													<a href="Article/SetArticle.asp" target="main">批量添加</a>
												</td>
											</tr>
										</tbody>
									</table>
									...
									<TABLE id=submenu4 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="User/Point_Log_ACT.asp" target=main>教师列表</A>
												</TD>
											</TR>
											<TR>
												<TD>
												...
												<TD height=23>
													<A href="User/Edays_User.asp" target=main>添加教师</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<TABLE id=submenu5 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="Label_Admin.asp?Type=1" target=main>最新留言</A>
												</TD>
											</TR>
											<TR>
												<TD>
												...
												<TD height=23>
													<A href="Label_Admin.asp?Type=2" target=main>留言历史</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
