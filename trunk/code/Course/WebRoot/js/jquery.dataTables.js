...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				"sProcessing": "搜索中...",
				"sLengthMenu": "一页显示  _MENU_ 条记录",
				"sZeroRecords": "没有查找到匹配记录。",
				"sInfo": "显示第  _START_ 到第  _END_ 条，总  _TOTAL_ 条记录",
				"sInfoEmpty": "显示第 0 到第 0 条，总 0 条记录",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input size=40 type="text" />';
