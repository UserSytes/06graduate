...
/**
 	* A data access object (DAO) providing persistence and search support for ApplicationForm entities.
...
public class ApplicationFormDAO extends HibernateDaoSupport  {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding ApplicationForm instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public List findByRecommender(Object recommender
	) {
		return findByProperty(RECOMMENDER, recommender
		);
	}
	...
	public List findBySecondSubject(Object secondSubject
	) {
		return findByProperty(SECOND_SUBJECT, secondSubject
		);
	}
	...
	public static ApplicationFormDAO getFromApplicationContext(ApplicationContext ctx) {
