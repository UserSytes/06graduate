...
public class NewsService implements INewsService {
	 ...
	 * 
	 * @see
	 * cn.edu.xmu.course.service.INewsService#addNewsWithoutAttachment(cn.edu
	 * .xmu.course.pojo.News)
	 */
	 ...
	 * @return
	 */
	public boolean createAttachments(News news, File[] myFile,
			String[] myFileContentType, String[] myFileFileName) {
		// 上传附件
		try {
			/*
			 * 开始上传多个附件
			...
			for (int i = 0; i < myFileFileName.length; i++) {
				String path = ServletActionContext.getServletContext()
						.getRealPath("/upload");
				String fileName = path + "/newsUpload/" + new Date().getTime()
						+ "_" + myFileFileName[i];
				...
				attachment.setFileLink("/newsUpload/" + new Date().getTime()
						+ "_" + myFileFileName[i]);
	 ...
	 * 
	 * @see
	 * cn.edu.xmu.course.service.INewsService#addNews(cn.edu.xmu.course.pojo
	 * .News, java.io.File[], java.lang.String[], java.lang.String[])
	 */
	public boolean addNews(News news, File[] myFile,
			String[] myFileContentType, String[] myFileFileName) {
		...
		return this.createAttachments(news, myFile, myFileContentType,
				myFileFileName);
	}
	 ...
	 * 
	 * @see
	 * cn.edu.xmu.course.service.INewsService#updateNews(cn.edu.xmu.course.pojo
	 * .News, java.io.File[], java.lang.String[], java.lang.String[])
	 */
	public boolean updateNews(News news, File[] myFile,
			String[] myFileContentType, String[] myFileFileName) {
		Date nowDate = new Date();
	 ...
	 * 
	 * @see
	 * cn.edu.xmu.course.service.INewsService#updateNewsWithoutAttachment(cn
	 * .edu.xmu.course.pojo.News)
	 */
	 ...
	 * 
	 * @see
	 * cn.edu.xmu.course.service.INewsService#findAttachmentByNews(cn.edu.xmu
	 * .course.pojo.News)
	 */
	 ...
	 * 
	 * @see
	 * cn.edu.xmu.course.service.INewsService#deleteNews(cn.edu.xmu.course.pojo
	 * .News)
	 */
