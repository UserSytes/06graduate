...
public class SearchCourseService implements ISearchCourseService {
	...
	public List<Course> findCourseByDepartmentAndTeacher(String teacherName, Department department){
		return courseDAO.findCourseByDepartmentAndTeacher(teacherName, department);
	}
	...
	public List<Course> findCourseByNameAndDepartmentAndTeacher(String courseName, Department department,  String teacherName){
		return courseDAO.findCourseByNameAndDepartmentAndTeacher(courseName, department, teacherName);
	}
