...
/**
 	* A data access object (DAO) providing persistence and search support for Achievement entities.
...
public class AchievementDAO extends HibernateDaoSupport  {
    ...
    public Achievement findById( java.lang.Integer id) {
        ...
        try {
            Achievement instance = (Achievement) getHibernateTemplate()
                    .get("cn.edu.xmu.course.pojo.Achievement", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Achievement merge(Achievement detachedInstance) {
        ...
        try {
            Achievement result = (Achievement) getHibernateTemplate()
	...
	public static AchievementDAO getFromApplicationContext(ApplicationContext ctx) {
