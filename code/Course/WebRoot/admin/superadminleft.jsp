        ...
        <TR>
          <TD height="25" style="background:url(Images/left_tt.gif) no-repeat">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <TD width="20"></TD>
          <TD class=STYLE1 style="CURSOR: hand" onclick=showsubmenu(1); height=25>新闻政策管理</TD>
              </tr>
            </table>            </TD>
          </TR>
        <TR>
      ...
      <tbody>
        <tr>
          <td height="25" style="background:url(Images/left_tt.gif) no-repeat"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20"></td>
          <td height="25" class="titledaohang" style="CURSOR: hand" onClick="showsubmenu(2);"><span class="STYLE1">院系管理</span></td>
              </tr>
            </table></td>
          </tr>
        <tr>
          <td><table id="submenu2" cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            target="main">学院列表</a>┆<a 
            href="schoolmanage/addschool.jsp" 
            target="main">添加学院</a></td>
                </tr>
                <tr>
                  <td><img src="Images/closed.gif" /></td>
                  <td height="23"><a 
            href="Article/Article_Manage.asp?action=ListisAccept" 
            target="main">学院管理员列表</a></td>
                </tr>	
                <tr>
                  <td><img src="Images/closed.gif" /></td>
                  <td height="23"><a 
            href="Article/Article_Manage.asp?action=ListisAccept" 
            target="main">添加学院管理员</a></td>
                </tr>				
              </tbody>
          </table></td>
        </tr>
    ...
    height=25>年级管理</TD>
        ...
        <TR>
          <TD><TABLE id=submenu4 cellSpacing=0 cellPadding=0 width="100%" border=0>
            ...
            target=main>年级列表</A> </TD>
                </TR>
                <TR>
                  <TD><IMG src="Images/closed.gif"></TD>
                  <TD height=23><A href="User/Edays_User.asp" 
            target=main>添加年级</A></TD>
                </TR>
              </TBODY>
          </TABLE></TD>
        </TR>
