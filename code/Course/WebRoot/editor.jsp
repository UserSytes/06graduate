...
<link rel="STYLESHEET" type="text/css" href="editor/edit.css">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<META HTTP-EQUIV="Pragma" CONTENT="no-cache"> 
<META HTTP-EQUIV="Cache-Control" CONTENT="no-cache"> 
<META HTTP-EQUIV="Expires" CONTENT="0">
<script language="Javascript1.1" src="js/gb_big5.js"></script> 
</head>
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="全部选择" LANGUAGE="javascript" onclick="format('selectall')"> 
    <img class="Ico" src="editor/images2/selectall.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="删除" LANGUAGE="javascript" onclick="format('delete')"> 
    <img class="Ico" src="editor/images2/del.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="剪切" LANGUAGE="javascript" onclick="format('cut')"> <img class="Ico" src="editor/images2/cut.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="复制" LANGUAGE="javascript" onclick="format('copy')"> 
    <img class="Ico" src="editor/images2/copy.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="粘贴" LANGUAGE="javascript" onclick="format('paste')"> 
    <img class="Ico" src="editor/images2/paste.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="撤消" LANGUAGE="javascript" onclick="format('undo')"> 
    <img class="Ico" src="editor/images2/undo.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="恢复" LANGUAGE="javascript" onclick="format('redo')"> 
    <img class="Ico" src="editor/images2/redo.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="插入表格" LANGUAGE="javascript" onclick="InsertTable()"> 
    <img class="Ico" src="editor/images2/table.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入栏目框" LANGUAGE="javascript" onclick="FIELDSET()"> <img class="Ico" src="editor/images2/fieldset.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入网页" LANGUAGE="javascript" onclick="iframe()"> <img class="Ico" src="editor/images2/htm.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入图片URL" LANGUAGE="javascript" onclick="pic()"> <img class="Ico" src="editor/images2/img.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
<!--   <iframe class="TBGen" style="top:2px" ID="UploadFiles" src="#" frameborder=0 scrolling=no width="250" height="25"></iframe> -->
  <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onclick="swf()"> 
    <img class="Ico" src="editor/images2/flash.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入视频文件，支持格式为：avi、wmv、asf" LANGUAGE="javascript" onclick="wmv()"> 
    <img class="Ico" src="editor/images2/wmv.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onclick="rm()"> 
    <img class="Ico" src="editor/images2/rm.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
    <div class="Btn" TITLE="插入超级连接" LANGUAGE="javascript" onclick="UserDialog('CreateLink')"> 
    <img class="Ico" src="editor/images2/url.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="取消超级链接" LANGUAGE="javascript" onclick="UserDialog('unLink')"> 
    <img class="Ico" src="editor/images2/nourl.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入普通水平线" LANGUAGE="javascript" onclick="format('InsertHorizontalRule')"> 
    <img class="Ico" src="editor/images2/line.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onclick="hr()"> <img class="Ico" src="editor/images2/sline.gif" WIDTH="18" HEIGHT="18"> 
  </div>
</div>
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="左对齐" name="Justify" LANGUAGE="javascript" onclick="format('justifyleft')"> 
    <img class="Ico" src="editor/images2/aleft.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="居中" name="Justify" LANGUAGE="javascript" onclick="format('justifycenter')"> 
    <img class="Ico" src="editor/images2/acenter.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="右对齐" name="Justify" LANGUAGE="javascript" onclick="format('justifyright')"> 
    <img class="Ico" src="editor/images2/aright.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="编号" LANGUAGE="javascript" onclick="format('insertorderedlist')"> 
    <img class="Ico" src="editor/images2/num.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="项目符号" LANGUAGE="javascript" onclick="format('insertunorderedlist')"> 
    <img class="Ico" src="editor/images2/list.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="减少缩进量" LANGUAGE="javascript" onclick="format('outdent')"> 
    <img class="Ico" src="editor/images2/outdent.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="增加缩进量" LANGUAGE="javascript" onclick="format('indent')"> 
    <img class="Ico" src="editor/images2/indent.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="删除文字格式" LANGUAGE="javascript" onclick="format('RemoveFormat')"> 
    <img class="Ico" src="editor/images2/clear.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="保存"	LANGUAGE="javascript" onclick="save()"> <img class="Ico" src="editor/images2/save.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
<!--   <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onclick="swf()"> 
    <img class="Ico" src="editor/images2/flash.gif" WIDTH="18" HEIGHT="18"> </div>
  ...
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onclick="rm()"> 
    <img class="Ico" src="editor/images2/rm.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div> -->
  <div class="Btn" TITLE="查看帮助" LANGUAGE="javascript" onclick="help()"> <img class="Ico" src="editor/images2/help.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="简&rarr;繁" LANGUAGE="javascript" onclick="s2t();"><img class="Ico" src="editor/images2/st.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="繁&rarr;简" LANGUAGE="javascript" onclick="t2s();"><img class="Ico" src="editor/images2/ts.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
</div>
<div class="yToolbar"> 
  <div class="TBHandle"> </div>
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="字体颜色" LANGUAGE="javascript" onclick="foreColor()"> <img class="Ico" src="editor/images2/fgcolor.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="加粗" LANGUAGE="javascript" onclick="format('bold')"> 
    <img class="Ico" src="editor/images2/bold.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="斜体" LANGUAGE="javascript" onclick="format('italic')"> 
    <img class="Ico" src="editor/images2/italic.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="下划线" LANGUAGE="javascript" onclick="format('underline')"> 
    <img class="Ico" src="editor/images2/underline.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="上标" LANGUAGE="javascript" onclick="format('superscript')"> 
    <img class="Ico" src="editor/images2/sup.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="下标" LANGUAGE="javascript" onclick="format('subscript')"> 
    <img class="Ico" src="editor/images2/sub.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
<!--   <div class="Btn" TITLE="插入超级连接" LANGUAGE="javascript" onclick="UserDialog('CreateLink')"> 
    <img class="Ico" src="editor/images2/url.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="取消超级链接" LANGUAGE="javascript" onclick="UserDialog('unLink')"> 
...
{
  if (!	validateMode())	return;
  var arr = showModalDialog("editor/selcolor.jsp", "", "dialogWidth:18.5em; dialogHeight:17.5em; status:0");
...
function InsertTable()
{
  ...
  var arr = showModalDialog("editor/table.jsp", "", "dialogWidth:300pt;dialogHeight:236pt;help:0;status:0");
...
function pic()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor/pic.jsp", "", "dialogWidth:30em; dialogHeight:15em; status:0;help:0");  
  if (arr != null){
  var ss;
  ss=arr.split("*")
  a=ss[0];
...
function swf()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor/flash.jsp", "", "dialogWidth:30em; dialogHeight:10em; status:0;help:0"); 
  if (arr != null){
  var ss;
  ss=arr.split("*")
  path=ss[0];
...
function hr()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor/hr.jsp", "", "dialogWidth:30em; dialogHeight:12em; status:0;help:0"); 
  if (arr != null){
  var ss;
  ss=arr.split("*")
  a=ss[0];
...
function FIELDSET()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor/fieldset.jsp", "", "dialogWidth:25em; dialogHeight:10em; status:0;help:0");
  if (arr != null){
  var ss;
  ss=arr.split("*")
  a=ss[0];
...
function iframe()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor/iframe.jsp", "", "dialogWidth:30em; dialogHeight:13em; status:0;help:0");  
  if (arr != null){
  var ss;
  ss=arr.split("*")
  a=ss[0];
...
function wmv()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor/media.jsp", "", "dialogWidth:30em; dialogHeight:10em; status:0;help:0");
  if (arr != null){
  var ss;
  ss=arr.split("*")
  path=ss[0];
...
function rm()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor/rm.jsp", "", "dialogWidth:30em; dialogHeight:10em; status:0;help:0");  
  if (arr != null){
  var ss;
  ss=arr.split("*")
  path=ss[0];
...
function help()
{
  var arr = showModalDialog("editor/help.jsp", "", "dialogWidth:580px; dialogHeight:460px; status:0");
}
