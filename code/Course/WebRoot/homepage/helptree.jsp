...
<html>
	...
	$(document).ready( function() {
		$('#tt').tree( {
			animate :true,
			url :'${ctx}/help_data.properties',
			onClick : function(node) {				
					var url  = "getHelpMovieAction.action";
					$('#courseListMain').load(url,{	treeId :node.id,treeName:node.text});
						...
						<tr>
							<td valign="top">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td>
											<img src="${ctx}/homepage/image/left_menu_title7.gif"
												border="0">
										</td>
									</tr>
									<tr>
							...
							<td valign="top">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="11"></td>
										<td align="left">
											<img src="${ctx}/homepage/image/title_help.gif" border="0"
												alt="">
										</td>
									</tr>
									<tr height="3">
						...
						<tr>
							<td valign="top" align="center">
								...
								<div id="courseListMain">
									<s:include value="helpdoc.jsp"></s:include>
								</div>
								<!-- /内容 -->
							</td>
						</tr>
