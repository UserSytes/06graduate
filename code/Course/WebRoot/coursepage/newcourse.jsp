			...
			<td>
				...
				<tr>
					...
					<td bgcolor="#fdfbf3">
						...
						<tr>
							<td width="750" valign="top" align="right"><font style="font-size:12px; color:#574434">首页 ><b>주요클리닉 ><b>비만클리닉</b></font></td></tr>
						<tr height="69">
							<td valign="bottom" align="left">
								<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td><img src="${ctx}/coursepage/classical/image/title.gif" border="0"></td>
								</tr>
								<tr>
									<td><img src="${ctx}/coursepage/classical/image/title_text.gif" border="0"></td></tr>
								</table></td></tr>
						<tr height="1">
						...
						<tr>
							<td>
								...
								<tr>
									<td width="24"></td>
									<td><font style="font-size:12px; color:#74582f">面向对象程序设计的雏形，早在1960年的Simula语言中即可发现，当时的程序设计领域正面临着一种危机：在软硬件环境逐渐复杂的情况下，软件如何得到良好的维护？面向对象程序设计在某种程度上通过强调可重复性解决了这一问题。20世纪70年代的Smalltalk语言在面向对象方面堪称经典——以至于30年后的今天依然将这一语言视为面向对象语言的基础。
