				...
				<tr>
					...
					<td bgcolor="#fdfbf3">
						...
						<tr>
							...
							<tr>
							<td>
								<table border="0" cellpadding="0" cellspacing="0" width="750" height="31" background="${ctx}/coursepage/classical/image/pro_titlebg.gif" style="background-repeat:no-repeat">
								<tr>
									<td width="10"></td>
						...
						<tr>
							<td>
								...
								<tr>
									<td width="24"></td>
									<td><font style="font-size:12px; color:#74582f"><s:text name="">${content}</s:text>
<br />
